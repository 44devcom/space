...
A special case of parsing fragments of OAS content would be if such fragments are embedded in another format, referred to as an _embedding format_ with respect to the OAS. Note that the OAS itself is an embedding format with respect to JSON Schema, which is embedded as Schema Objects. It is the responsibility of an embedding format to define how to parse embedded content, and OAS implementations that do not document support for an embedding format cannot be expected to parse embedded OAS content correctly.
...
* Source: Security Requirement Object {name}
  * Target: Security Scheme Object name under the Components Object
  * Alternative: n/a
* Source: Discriminator Object mapping (implicit, or explicit name syntax)
  * Target: Schema Object name under the Components Object
  * Alternative: mapping (explicit URI syntax)
* Source: Operation Object tags
  * Target: Tag Object name (in the OpenAPI Object's tags array)
  * Alternative: n/a
* Source: Link Object operationId
  * Target: Path Item Object operationId
  * Alternative: operationRef
...
* OAS < 3.1: type: stringformat: binary
  * OAS 3.1: contentMediaType: image/png
  * Comments: if redundant, can be omitted, often resulting in an empty Schema Object
* OAS < 3.1: type: stringformat: byte
  * OAS 3.1: type: stringcontentMediaType: image/pngcontentEncoding: base64
  * Comments: note that base64url can be used to avoid re-encoding the base64 string to be URL-safe
...
* Field Name: servers
  * Type: [Server Object]
  * Description: An array of Server Objects, which provide connectivity information to a target server. If the servers field is not provided, or is an empty array, the default value would be a Server Object with a url value of /.
* Field Name: paths
  * Type: Paths Object
...
* Field Name: components
  ...
  * Description: An element to hold various Objects for the OpenAPI Description.
* Field Name: security
...
* Field Name: tags
  * Type: [Tag Object]
  * Description: A list of tags used by the OpenAPI Description with additional metadata. The order of the tags can be used to reflect on their order by the parsing tools. Not all tags that are used by the Operation Object must be declared. The tags that are not declared MAY be organized randomly or based on the tools' logic. Each tag name in the list MUST be unique.
* Field Name: externalDocs
...
* Field Name: version
  * Type: string
  * Description: REQUIRED. The version of the OpenAPI Document (which is distinct from the OpenAPI Specification version or the version of the API being described or the version of the OpenAPI Description).
...
* Field Name: url
  * Type: string
  * Description: REQUIRED. A URL to the target host. This URL supports Server Variables and MAY be relative, to indicate that the host location is relative to the location where the document containing the Server Object is being served. Variable substitutions will be made when a variable is named in {braces}.
* Field Name: description
  * Type: string
...
* Field Name: variables
  * Type: Map[string, Server Variable Object]
...
* Field Name: $ref
  * Type: string
  * Description: Allows for a referenced definition of this path item. The value MUST be in the form of a URI, and the referenced structure MUST be in the form of a Path Item Object. In case a Path Item Object field appears both in the defined object and the referenced object, the behavior is undefined. See the rules for resolving Relative References. Note: The behavior of $ref with adjacent properties is likely to change in future versions of this specification to bring it into closer alignment with the behavior of the Reference Object.
* Field Name: summary
  * Type: string
...
* Field Name: servers
  * Type: [Server Object]
  * Description: An alternative servers array to service all operations in this path. If a servers array is specified at the OpenAPI Object level, it will be overridden by this value.
* Field Name: parameters
...
* Field Name: servers
  * Type: [Server Object]
  * Description: An alternative servers array to service this operation. If a servers array is specified at the Path Item Object or OpenAPI Object level, it will be overridden by this value.
...
* Field Name: url
  * Type: string
  * Description: REQUIRED. The URI for the target documentation. This MUST be in the form of a URI.
...
* Field Name: required
  * Type: boolean
  * Description: Determines whether this parameter is mandatory. If the parameter location is "path", this field is REQUIRED and its value MUST be true. Otherwise, the field MAY be included and its default value is false.
* Field Name:  deprecated
  * Type: boolean
  * Description: Specifies that a parameter is deprecated and SHOULD be transitioned out of usage. Default value is false.
* Field Name:  allowEmptyValue
  * Type: boolean
  * Description: If true, clients MAY pass a zero-length string value in place of parameters that would otherwise be omitted entirely, which the server SHOULD interpret as the parameter being unused. Default value is false. If style is used, and if behavior is n/a (cannot be serialized), the value of allowEmptyValue SHALL be ignored. Interactions between this field and the parameter's Schema Object are implementation-defined. This field is valid only for query parameters. Use of this field is NOT RECOMMENDED, and it is likely to be removed in a later revision.
...
* style: matrix
  ...
  * in: path
  * Comments: Path-style parameters defined by RFC6570
* style: label
  * type: primitive, array, object
  * in: path
  * Comments: Label style parameters defined by RFC6570
* style: simple
  * type: primitive, array, object
  * in: path, header
  * Comments: Simple style parameters defined by RFC6570. This option replaces collectionFormat with a csv value from OpenAPI 2.0.
* style: form
  * type: primitive, array, object
  * in: query, cookie
  * Comments: Form style parameters defined by RFC6570. This option replaces collectionFormat with a csv (when explode is false) or multi (when explode is true) value from OpenAPI 2.0.
* style: spaceDelimited
  * type: array, object
  * in: query
  * Comments: Space separated array values or object properties and values. This option replaces collectionFormat equal to ssv from OpenAPI 2.0.
* style: pipeDelimited
  * type: array, object
  * in: query
  * Comments: Pipe separated array values or object properties and values. This option replaces collectionFormat equal to pipes from OpenAPI 2.0.
* style: deepObject
  * type: object
  * in: query
  * Comments: Allows objects with scalar properties to be represented using form parameters. The representation of array or object properties is not defined.
...
* Field Name: schema
  * Type: Schema Object
  * Description: The schema defining the content of the request, response, parameter, or header.
* Field Name: example
  * Type: Any
  * Description: Example of the media type; see Working With Examples.
* Field Name: examples
  * Type: Map[ string, Example Object | Reference Object]
  * Description: Examples of the media type; see Working With Examples.
* Field Name: encoding
  * Type: Map[string, Encoding Object]
...
* Field Name: contentType
  * Type: string
  * Description: The Content-Type for encoding a specific property. The value is a comma-separated list, each element of which is either a specific media type (e.g. image/png) or a wildcard media type (e.g. image/*). Default value depends on the property type as shown in the table below.
* Field Name: headers
  * Type: Map[string, Header Object | Reference Object]
  * Description: A map allowing additional information to be provided as headers. Content-Type is described separately and SHALL be ignored in this section. This field SHALL be ignored if the request body media type is not a multipart.
...
* Field Name: default
  * Type: Response Object | Reference Object
...
* Field Pattern: HTTP Status Code
  * Type: Response Object | Reference Object
...
* Field Pattern: {expression}
  * Type: Path Item Object
  * Description: A Path Item Object used to define a callback request and expected responses. A complete example is available.
...
* Expression: $url
  * Value: https://example.org/subscribe/myevent?queryUrl=https://clientdomain.com/stillrunning
* Expression: $method
  * Value: POST
* Expression: $request.path.eventType
  * Value: myevent
* Expression: $request.query.queryUrl
  * Value: https://clientdomain.com/stillrunning
* Expression: $request.header.content-type
  * Value: application/json
* Expression: $request.body#/failedUrl
  * Value: https://clientdomain.com/failed
* Expression: $request.body#/successUrls/1
  * Value: https://clientdomain.com/medium
* Expression: $response.header.Location
  * Value: https://example.org/subscription/1
...
* Field Name: externalValue
  * Type: string
  * Description: A URI that identifies the literal example. This provides the capability to reference examples that cannot easily be included in JSON or YAML documents. The value field and externalValue field are mutually exclusive. See the rules for resolving Relative References.
...
* Field Name: operationRef
  * Type: string
  * Description: A URI reference to an OAS operation. This field is mutually exclusive of the operationId field, and MUST point to an Operation Object. Relative operationRef values MAY be used to locate an existing Operation Object in the OpenAPI Description.
* Field Name: operationId
  * Type: string
...
* Field Name: parameters
  * Type: Map[string, Any | {expression}]
...
Note that in the use of `operationRef` the _escaped forward-slash_ is necessary when using JSON Pointer, and it is necessary to URL-encode `{` and `}` as `%7B` and `%7D`, respectively, when using JSON Pointer as URI fragments.
...
* Source Location: HTTP Method
  * example expression: $method
  * notes: The allowable values for the $method will be those for the HTTP operation.
* Source Location: Requested media type
  * example expression: $request.header.accept
  * notes: 
* Source Location: Request parameter
  * example expression: $request.path.id
  * notes: Request parameters MUST be declared in the parameters section of the parent operation or they cannot be evaluated. This includes request headers.
* Source Location: Request body property
  * example expression: $request.body#/user/uuid
  * notes: In operations which accept payloads, references may be made to portions of the requestBody or the entire body.
* Source Location: Request URL
  * example expression: $url
  * notes: 
* Source Location: Response value
  * example expression: $response.body#/status
  * notes: In operations which return payloads, references may be made to portions of the response body or the entire body.
* Source Location: Response header
  * example expression: $response.header.Server
  * notes: Single header values only are available
...
* Field Name: required
  * Type: boolean
  * Description: Determines whether this header is mandatory. The default value is false.
* Field Name:  deprecated
  * Type: boolean
  * Description: Specifies that the header is deprecated and SHOULD be transitioned out of usage. Default value is false.
...
When `example` or `examples` are provided in conjunction with the `schema` field, the example SHOULD match the specified schema and follow the prescribed serialization strategy for the header. The `example` and `examples` fields are mutually exclusive, and if either is present it SHALL _override_ any `example` in the schema.



* Field Name: style
  * Type: string
  * Description: Describes how the header value will be serialized. The default (and only legal value for headers) is "simple".
* Field Name: explode
  * Type: boolean
  * Description: When this is true, header values of type array or object generate a single header whose value is a comma-separated list of the array items or key-value pairs of the map, see Style Examples. For other data types this field has no effect. The default value is false.
* Field Name: schema
  * Type: Schema Object | Reference Object
  * Description: The schema defining the type used for the header.
* Field Name: example
  * Type: Any
  * Description: Example of the header's potential value; see Working With Examples.
* Field Name: examples
  * Type: Map[ string, Example Object | Reference Object]
  * Description: Examples of the header's potential value; see Working With Examples.
...
* Field Name: content
  * Type: Map[string, Media Type Object]
  * Description: A map containing the representations for the header. The key is the media type and the value describes it. The map MUST only contain one entry.
...
The OpenAPI Specification allows combining and extending model definitions using the `allOf` keyword of JSON Schema, in effect offering model composition. `allOf` takes an array of object definitions that are validated _independently_ but together compose a single object.
...
* Field Name: propertyName
  * Type: string
  * Description: REQUIRED. The name of the property in the payload that will hold the discriminating value. This property SHOULD be required in the payload schema, as the behavior when the property is absent is undefined.
* Field Name:  mapping
  * Type: Map[string, string]
  * Description: An object to hold mappings between payload values and schema names or URI references.
...
The `allOf` form of `discriminator` is _only_ useful for non-validation use cases; validation with the parent schema with this form of `discriminator` _does not_ perform a search for child schemas or use them in validation in any way. This is because `discriminator` cannot change the validation outcome, and no standard JSON Schema keyword connects the parent schema to the child schemas.
...
The value of the property named in `propertyName` is used as the name of the associated schema under the [Components Object](#components-object), _unless_ a `mapping` is present for that value. The `mapping` entry maps a specific property value to either a different schema component name, or to a schema identified by a URI. When using implicit or explicit schema component names, inline `oneOf` or `anyOf` subschemas are not considered. The behavior of a `mapping` value that is both a valid schema name and a valid relative URI reference is implementation-defined, but it is RECOMMENDED that it be treated as a schema name. To ensure that an ambiguous value (e.g. `"foo"`) is treated as a relative URI reference by all implementations, authors MUST prefix it with the `"."` path segment (e.g. `"./foo"`).
...
* Field Name: namespace
  * Type: string
  * Description: The URI of the namespace definition. Value MUST be in the form of a non-relative URI.
* Field Name: prefix
  * Type: string
...
* Field Name: scheme
  * Type: string
  * Applies To: http
  * Description: REQUIRED. The name of the HTTP Authentication scheme to be used in the Authorization header as defined in RFC7235. The values used SHOULD be registered in the IANA Authentication Scheme registry. The value is case-insensitive, as defined in RFC7235.
* Field Name: bearerFormat
  * Type: string
...
* Field Name: openIdConnectUrl
  * Type: string
  * Applies To: openIdConnect
  * Description: REQUIRED. Well-known URL to discover the [[OpenID-Connect-Discovery]] provider metadata.
...
* Field Pattern: ^x-
  * Type: Any
  * Description: Allows extensions to the OpenAPI Schema. The field name MUST begin with x-, for example, x-internal-id. Field names beginning x-oai- and x-oas- are reserved for uses defined by the OpenAPI Initiative. The value can be any valid JSON value (null, a primitive, an array, or an object.)
...
* Object: Parameter Object
  * Condition: When schema is present
* Object: Header Object
  * Condition: When schema is present
* Object: Encoding Object
  * Condition: When encoding for application/x-www-form-urlencoded and any of style, explode, or allowReserved are used
...
* Specification: RFC3986
  * Date: 01/2005
  * OAS Usage: URI/URL syntax
  * Percent-Encoding: [[RFC3986]]
  * Notes: obsoletes [[RFC1738]], [[RFC2396]]
* Specification: RFC6570
  * Date: 03/2012
  * OAS Usage: style-based serialization
  * Percent-Encoding: [[RFC3986]]
  * Notes: does not use + for form‑urlencoded
* Specification: RFC1866
  * Date: 11/1995
  * OAS Usage: content-based serialization
  * Percent-Encoding: [[RFC1738]]
  * Notes: obsoleted by [[HTML401]] Section 17.13.4.1, [[URL]] Section 5
